...
import { Button, Checkbox, Container, Input, Typography } from '@/components/atoms';
...
const HomeForm = () => {
  ...
  return (
    <Container direction='column'>
      ...
      <SelectInput
        inputValue={form.document}
        onInputChange={({ target }) => setForm({
          ...form,
          document: target.value,
        })}
        inputPlaceholder='Nro. de documento'
        selectValue={form.type}
        selectOnChange={({ target }) => setForm({
          ...form,
          type: target.value,
        })}
        selectOptions={[
